...
f, (row1,row21,row2,row22,row3,row23,row4,row24) = plot.subplots(nrows=8, ncols=3, sharex=False, sharey=False)
...
for im,leg in zip( [images[0],images[3]], [names[0],names[3]] ):
    ...
    row21[0].plot(xsize1,im.get1dlist([1,0,1]),alpha=0.5,color=col,label=leg,lw=lw)
    row21[1].plot(xsize1,im.get1dlist([0,1,1]),alpha=0.5,color=col,label=leg,lw=lw)
    row21[2].plot(xsize2,im.get1dlist([1,1,0]),alpha=0.5,color=col,label=leg,lw=lw)
...
for im,leg in zip( images[1:], names[1:] ):
    col=random.choice(plot.colors)
    row4[0].plot(xsize1,im.getline('y'),alpha=0.5,color=col,label=leg,lw=lw)
    row4[1].plot(xsize1,im.getline('z'),alpha=0.5,color=col,label=leg,lw=lw)
    row4[2].plot(xsize2,im.getline('x'),alpha=0.5,color=col,label=leg,lw=lw)
    row24[0].plot(xsize1,im.get1dlist([1,0,1]),alpha=0.5,color=col,label=leg,lw=lw)
    row24[1].plot(xsize1,im.get1dlist([0,1,1]),alpha=0.5,color=col,label=leg,lw=lw)
    row24[2].plot(xsize2,im.get1dlist([1,1,0]),alpha=0.5,color=col,label=leg,lw=lw)
