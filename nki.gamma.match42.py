...
spec = importlib.util.spec_from_file_location("M42_Python", r"D:\install\Match42\python\M42_Python.py")
...
## general imports
import subprocess,collections,os,glob,plot,sys
...
local_dose_dir = r"Z:\brent\stijn\pindump"
#local_dose_dir = r"Z:\brent\dosia_validatiedump\AA171214\Epid_6MV_COM.trialname.1.beam"
...
if sys.argv[-1] != 'update':
	...
	for frac,beams in fractions.items():
		...
		cmd = gammatool+' /dose1 '+tpsdosesum_fname+' /dose2 '+gpumcddosesum_fname
		#+' /outdir '+os.path.dirname(gpumcddosesum_fname)
		#print(cmd)
